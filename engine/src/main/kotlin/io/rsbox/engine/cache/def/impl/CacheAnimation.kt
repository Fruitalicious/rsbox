 ...
 */
class CacheAnimation(override var id: Int, override val configType: ConfigType = ConfigType.SEQUENCE) : CacheDef(id, configType), io.rsbox.api.cache.types.CacheAnimation {
    ...
    override val duration: Int get() = lengthInCycles
