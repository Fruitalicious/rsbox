...
enum class ClientPacketTypes(val opcode: Int, val length: Int) {
    IF_BUTTON10(0, 8),
    OPNPC2(1, 3),
    OPHELDT(2, 14),
    OPLOC4(3, 7),
    ...
    companion object {
        val values = enumValues<ClientPacketTypes>()

        fun forOpcode(opcode: Int): ClientPacketTypes? = values.associate { it.opcode to it }[opcode]
    }
}